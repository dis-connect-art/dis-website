  ...
  return (
    <section>
      <article className={styles.article}>
        ...
        words. The only agreed upon concept was disconnection. With barriers of
        distance, language, medium and confusion between them, the message
        dissolved and three products emerged.
        <br />
        <br />
